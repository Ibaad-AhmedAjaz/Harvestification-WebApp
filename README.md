...
- Clone the complete project with `https://github.com/Ibaad-AhmedAjaz/Harvestification-WebApp.git` or you can just download the code and unzip it
- **Note:** The master branch doesn't have the updated code used for deployment, to download the updated code used for deployment you can use the following command
  ```
  ❯ git clone -b deploy https://github.com/Ibaad-AhmedAjaz/Harvestification-WebApp.git
  ```
...
## Usage ⚙️
You can use this project for further developing it and adding your work in it.
...
## Credits 💳
This project is heavily inspired from **[this GitHub repository](https://github.com/7NNS7/Recommendation-System-for-Farming)** (especially the crop recommendation and fertilizer recommendation part). This project is an extended version of the above mentioned project.


## Contact 📞

#### If you have any doubt or want to contribute feel free to email me or hit me up on [LinkedIn](https://www.linkedin.com/in/ibaadahmed077/)
"# Harvestification-WebApp" 
